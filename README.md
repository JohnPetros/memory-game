...
## ✅ Demonstração
| Login | Login |
|<img alt="Tela de Login" src=".github/login.png" />|<img alt="Tela de Cadastro" src=".github/register.png" />   |
| Login | Login |
|<img alt="Tela de configuração de baralho" src=".github/deck.png" />|<img alt="Tela de ranking de usuários" src=".github/leaderboard.png" />|
| Login | Login |
|<img alt="Tela de perfil de usuário" src=".github/profile.png" />|<img alt="Jogo da memória funcionando" src=".github/memory-game.gif" />|
